...
cout<<sizeof(b+0)<<endl;  //4, or 8
cout<<sizeof(*(b+0))<<endl; //8
// the next line prints 0012FF4C
cout<<"The address of b is: "<<b<<endl; //0012FF4C
cout<<"The address of b+1 is: "<<b+1<<endl; //0012FF64
cout<<"*(b+1) is: "<<*(b+1)<<endl<<endl; //0012FF64
cout<<"The address of &b is: "<<&b<<endl;  //0012FF4C
cout<<"The address of &b+1 is: "<<&b+1<<endl<<endl; //0012FF64
return 0;
}
